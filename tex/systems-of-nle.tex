...
% \caption{Illustration of local uniqueness in 2D. Star: A locally unique solution where the curves intersect transversely. Dashed circle: A potentially non-unique solution where the curves are tangent.}
\end{center}
\end{definitionBox}  

The tool for determining local uniqueness is the \textbf{Jacobian matrix}, which generalizes the derivative to vector-valued functions.
