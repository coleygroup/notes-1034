...
\begin{exercise} % 2025 "Final extra problems" Nathan Morgan
    (*) Using the Thomas algorithm from Exercise~\ref{ex:thomas-algorithm},
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        grid point.  That is, find an expression for each of $a_i$,
        $b_i$, $c_i$, and $d_i$.  Use a step size of $\Delta t$.  To
        obtain a tridiagonal system, use a centered 2nd-order finite
        difference for the interior points and a backward 1st-order
        finite difference for the final point.

        \item What practical challenges could we experience if $\Delta t$
        is too small?
...
\begin{solution}
    \begin{enumerate}[label=(\alph*)]
        ...
        \[
            ...
            \end{pmatrix}.
        \]
        From this we get $a_i = -1$, $b_i = 2\Delta t$, and $c_i = 1$,
        with $a_0 = 0$ because of the boundary conditions.
        ...
        \item Probably there won't be a problem with the number of
        steps because the scaling is $\mathcal{O}(n)$.  But in the Thomas
        algorithm, we divide by $b_i$.  If this is too small, we could run
...
\begin{exercise} % 2025 "Final extra problems" Nathan Morgan
    (*) What is the order of accuracy of the following estimation of the first
    derivative at a point?  Assume $\Delta x_{i-1} \neq \Delta x_i$, with
