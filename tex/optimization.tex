...
\begin{exercise} % 2020 Participation quiz L11
    \begin{tikzpicture}[x=1cm,y=1cm]
        ...
        \draw[red] (1.6,1.6) circle (0.3cm);
        \draw[red] (1.6,1.6) circle (0.7cm);
        \draw[red] (1.6,1.6) circle (1.1cm);

        \draw[red,rounded corners=1.2cm] (0.05,0.05) rectangle (3.2,3.20);
...
\begin{solution}
    ...
    \begin{tikzpicture}
        ...
        (3.6,4.5),(3.6,4.0),(3.3,3.4),(2.9,2.9),(2.3,2.3),(1.9,1.9),(1.6,1.6)%
        }
    \end{tikzpicture}
\end{solution}
...
\begin{exercise} % 2020 Participation quiz L12
    ...
    \begin{tikzpicture}[x=1cm,y=1cm]
        ...
        \node[red] at (5.8,3.60) {$f(\mathbf{x})$};
    \end{tikzpicture}
\end{exercise}

\begin{solution}
    A defining characteristic of constrained optimization is that the solution is at a tangent point between a contour and the constrain. The smallest contour in contact with teh constraint is \(f(\mathbf{x})=3\), and its tangent point to the constraint is shown in blue.
