...
\begin{exercise} % 2020 Participation quiz L33
    Consider the system with \ce{I + I -> D} where the number of I initially is 5 and the number of D is 0.\\
    ...
    Write a \textsc{matlab} script to solve the CME with $c = 1$ and compute the average number of I with time.
\end{exercise}
